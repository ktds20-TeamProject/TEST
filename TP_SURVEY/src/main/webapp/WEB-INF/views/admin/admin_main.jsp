	...
	<div class="container">
		...
		<div class="row" style="text-align: center;">
			<div class="col-md-12">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="button" class="btn btn-warning btn-sm"
								value="수정" onclick="#;" /> <input type="button"
								class="btn btn-danger btn-sm" value="삭제"
								onclick="if(confirm('설문을 삭제 하시겠습니까?') == true){ 
								}else{ return ;}" />
								<%-- confirm() 메소드는 삭제 유무를 판단하는 확인/취소 버튼을 가진 경고창을 띄움(자바스크립트)
								   확인을 클릭하면 true, 취소를 클릭하면 false를 반환 --%></td>
						</tr>
						<tr>
							<th scope="row">2</th>
				...
				<div class="row">
					<div class="col-md-11">
						<form name="frmSurveyMake" method="GET" action="${contextPath}/surveymake.do">
							<button type="submit" class="btn btn-outline-primary"
								style="float: right;">설문만들기</button>
						</form>
					</div>
				</div>
				<br>
				...
				<nav aria-label="Page navigation example">
					<ul class="justify-content-center pagination">
						<%--justify-content-center 네브 바 중앙정렬--%>
						<li class="page-item"><a class="text-dark page-link" href="#"
				...
				<div id="#">
					...
					</select> <input name="#" id="#" size="14" value="" /> <input type="submit"
